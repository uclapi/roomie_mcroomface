...
society_booking = Permission.objects.create(codename = 'can_book_society_rooms', name = 'Can book society rooms', content_type = booking_society)
...
booking = Permission.objects.create(codename = 'can_book_normal_rooms', name = 'Can book normal rooms', content_type = normal_booking)
...
permission3 = Permission.objects.create(codename = 'can_book_90_days_in_advance', name = 'Can book 90 days in advance', content_type = normal_booking)
