...
```shell
curl http://enghub.io/user.login.status/
```

```python
import requests

requests.get("http://enghub.io/user.login.status/")
```

```javascript
var xhr = new XMLHttpRequest();
xhr.open('GET', 'http://enghub.io/user.login.status/', true);
xhr.send();
...
```shell
curl --data "sid=shibpescvktqatuvacymiwxhewsrrvsybexcijjpskcrcvngylmquwszbbtoujpd" http://enghub.io/user.login.status/
```
...
requests.post("http://enghub.io/user.login.status/", data=data)
```

```javascript
var xhr = new XMLHttpRequest();
xhr.open('POST', 'http://enghub.io/user.login.status/', true);
...
```shell
curl http://enghub.io/rooms.list/ -H 'Authorization: Token <auth_token_here>'
```

```python
import requests

r = requests.get("http://enghub.io/rooms.list/", headers={"Authorization": "Token 57087bd9cc3cde97515a66bc0b58d29696063fd5"})
```

```javascript
// token
var xhr = new XMLHttpRequest();
xhr.open('GET', "http://enghub.io/rooms.list/", true);
...
```shell
curl "http://enghub.io/rooms.bookings/?room_id=RO-PIZZA&date=20160808" -H 'Authorization: Token <auth_token_here>'
```
```python
import requests
...
r = requests.get("http://enghub.io/rooms.bookings/", params=params, headers=headers)
...
// headers
var xhr = new XMLHttpRequest();
xhr.open('GET', "http://enghub.io/rooms.bookings/?room_id=RO-PIZZA&date=20160808", true);
xhr.setRequestHeader('Authorization', 'Token <auth_token_here>');
xhr.send();
...
```shell
curl http://enghub.io/rooms.book/
...
```javascript
var xhr = new XMLHttpRequest();
xhr.open('POST', 'http://enghub.io/rooms.book/', true);
xhr.setRequestHeader('Authorization', 'Token <auth_token_here>');
xhr.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
...
```shell
curl http://enghub.io/user.bookings/?date=20160808 -H 'Authorization: Token <auth_token_here>'
...
```javascript
var xhr = new XMLHttpRequest();
xhr.open('GET', "http://enghub.io/user.bookings/?date=20160808", true);
xhr.setRequestHeader('Authorization', 'Token <auth_token_here>');
xhr.send();
...
```shell
curl http://enghub.io/society.token/?society_id=SOTECHSOC -H 'Authorization: Token <auth_token_here>'
```
...
```javascript
var xhr = new XMLHttpRequest();
xhr.open('GET', "http://enghub.io/society.token?society_id=SOTECHSOC", true);
xhr.setRequestHeader('Authorization', 'Token <auth_token_here>');
xhr.send();
...
```javascript
var xhr = new XMLHttpRequest();
xhr.open('GET', "http://enghub.io/rooms.deleteBooking/?booking_id=21cf0a17-4b64-4a5f-9a0e-9381d4195af1", true);
xhr.setRequestHeader('Authorization', 'Token <auth_token_here>');
xhr.send();
...
```shell
curl --data "username=rema&society_id=SOTECHSOC" http://enghub.io/society.addUser/ -H 'Authorization: Token <auth_token_here>'
```
...
```javascript
var xhr = new XMLHttpRequest();
xhr.open('POST', "http://enghub.io/society.addUser/", true);
xhr.setRequestHeader('Authorization', 'Token <auth_token_here>');
xhr.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
...
```shell
curl --data "username=rema&society_id=SOTECHSOC" http://enghub.io/society.deleteUser/ 'Authorization: Token <auth_token_here>'
```
...
```javascript
var xhr = new XMLHttpRequest();
xhr.open('POST', "http://enghub.io/society.deleteUser/", true);
xhr.setRequestHeader('Authorization', 'Token <auth_token_here>');
xhr.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
xhr.send("username=rema&society_id=SOTECHSOC");
...
```shell
curl http://enghub.io/user.logout/ 'Authorization: Token <auth_token_here>'
```
...
```javascript
var xhr = new XMLHttpRequest();
xhr.open('GET', "http://enghub.io/user.logout/", true);
xhr.setRequestHeader('Authorization', 'Token <auth_token_here>');
xhr.send();
